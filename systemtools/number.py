...
def parseNumber(text):
    """
        Parse the first number in the given text for any locale.
        TODO parse most cases but don't take into account spaces
        for only 3-digited numbers (like "1 000") so "1 0" is 10.
